...
export const artifacts: Artifact[] = [
  ...
  { slug: 'kv-capsules-pti', order: 6, category: 'human-tools',
    name: 'KV Capsules + PTI', emphasisWord: 'KV Capsules',
    description: 'Research system for preserving local-agent context as reusable attention state instead of replayed text.',
    stack: 'llama.cpp · gemma 4 12b · local agents', kind: 'research · local agent runtime', status: 'private',
    metricOverride: '13.8x faster repeated-work run',
    installCommand: '# research artifact — read the paper' },

  { slug: 'explain', order: 7, category: 'human-tools',
  ...
  { slug: 'openrank', order: 8, category: 'human-tools',
  ...
  { slug: 'wireflow', order: 9, category: 'human-tools',
  ...
  { slug: 'agent-office', order: 10, category: 'human-tools',
  ...
  { slug: 'hunt', order: 11, category: 'human-tools',
