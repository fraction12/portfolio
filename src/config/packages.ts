...
export const artifacts: Artifact[] = [
  ...
  { slug: 'explain', order: 6, category: 'human-tools',
  ...
  { slug: 'openrank', order: 7, category: 'human-tools',
  ...
  { slug: 'wireflow', order: 8, category: 'human-tools',
  ...
  { slug: 'agent-office', order: 9, category: 'human-tools',
  ...
  { slug: 'hunt', order: 10, category: 'human-tools',
